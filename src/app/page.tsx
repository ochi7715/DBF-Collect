    ...
    <style
      dangerouslySetInnerHTML={{
        __html: `
          ...
          @media (max-width:640px){.paddle-header{align-items:flex-start}.paddle-brand-mark{width:3.35rem}.paddle-brand-subtitle{font-size:.63rem}.paddle-nav .paddle-button-ghost{display:none}.paddle-button{padding:.68rem .82rem}.paddle-copy{padding:3.6rem 0 3.8rem}.paddle-hero-logo{width:min(18rem,82vw);margin-left:-.5rem}.paddle-home h1{font-size:clamp(3.4rem,17vw,5rem)}.paddle-lede{font-size:1.08rem}.paddle-actions .paddle-button{width:100%}.paddle-scoreboard{grid-template-columns:1fr 1fr}.paddle-scene-logo{display:none}.paddle-sun{top:18vh;right:-12rem;width:22rem;opacity:.72}.paddle-boat{bottom:8vh;right:-18rem;width:32rem;opacity:.22}.paddle-lane,.paddle-spark{display:none}}
