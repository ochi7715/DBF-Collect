...
4. Team contacts accept their email invitation and use the portal to add team members, complete roster details, generate Forms A/B, upload remaining team-level forms, and upload each member's Form C.
5. Admins review all uploads from **Back office -> Document inbox**.
